> **本仓库是白霜拼音（rime-frost）的修改版，由齐我输入法（Qiwo）维护。**
>
> - 上游：<https://github.com/gaboolic/rime-frost> @ `6af2892`（`1.0.4-12-g6af2892`）
> - 首次导入并修改：2026-08-31
> - 修改内容与再导入流程见 [QIWO-CHANGES.md](QIWO-CHANGES.md)
> - 许可保持 GPL-3.0 不变，见 [LICENSE](LICENSE)
>
> 以下为上游原始 README，未作改动。
